...
<template>
    <div class="themeSelection">
        ...
        couleurs en hexadecimal, ce qui est illisible pour un humain.       -->
            <input v-if="initialThemeId == 1" checked type="radio" name="theme" value="1" v-model="selectedThemeId"
                data-colors="black-white" />
            <input v-if="initialThemeId != 1" type="radio" name="theme" value="1" v-model="selectedThemeId"
                data-colors="black-white" />
            <label for="red-white">Black-white</label><br />
            <input v-if="initialThemeId == 2" checked type="radio" name="theme" value="2" selected="true"
                v-model="selectedThemeId" data-colors="black-white" />
            <input v-if="initialThemeId != 2" type="radio" name="theme" value="2" selected="true"
                v-model="selectedThemeId" data-colors="black-white" />
